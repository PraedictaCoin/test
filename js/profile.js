...
async function renderHallOfFame() {
    const container = DOM.hallOfFameList; if (!container) return;
    const predictions = await loadHallOfFame();
    container.innerHTML = predictions.length === 0
    ? '<div class="empty-state"><div class="empty-state-icon">🏛️</div><p>No resolved predictions yet.</p><p style="font-size:.8rem;">Predictions appear here after they are resolved!</p></div>'
