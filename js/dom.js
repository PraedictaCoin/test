...
function cacheDOM() {
    ...
    DOM.notifTwoFactor = document.getElementById('notifTwoFactor');
    ...
    DOM.createFab = document.getElementById('createFab');
    ...
    DOM.gameStoreBtn = document.getElementById('gameStoreBtn');
    DOM.settingsBlindVoting = document.getElementById('settingsBlindVoting');
DOM.togglePushBtn = document.getElementById('togglePushBtn');
DOM.pushStatus = document.getElementById('pushStatus');
}
cacheDOM();
